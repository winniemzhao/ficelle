...
user_file1 = URI.open("https://www.computerhope.com/jargon/g/guest-user.jpg", {'User-Agent' => 'ruby'})
...
user_file3 = URI.open("https://www.computerhope.com/jargon/g/guest-user.jpg", {'User-Agent' => 'ruby'})
...
partner_file1 = URI.open("https://corporate.zalando.com/sites/default/files/styles/fullimage_extra_big/public/media/Zalando%20SE_brand%20partner_teaser%20image.jpg", {'User-Agent' => 'ruby'})
...
file1 = URI.open("https://phi.ca/uploads/_1920xAUTO_crop_center-center_80_none/yayoi-kusama-fondation.jpg", {'User-Agent' => 'ruby'})
...
file2 = URI.open("https://pyxis.nymag.com/v1/imgs/e8e/c68/83930d962edd0049116885bd6033c8492e.2x.rhorizontal.w600.jpg", {'User-Agent' => 'ruby'})
...
file3 = URI.open("https://cafechatlheureux.com/content/images/cats/Milady.JPG", {'User-Agent' => 'ruby'})
...
file4 = URI.open("https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/sunrise-quotes-21-1586892331.jpg", {'User-Agent' => 'ruby'})
...
file5 = URI.open("https://media-cdn.tripadvisor.com/media/photo-m/1280/1b/1a/ee/08/photo0jpg.jpg", {'User-Agent' => 'ruby'})
...
file6 = URI.open("https://i.pinimg.com/originals/e2/1e/c3/e21ec38a960ed856a9cbc2950654818c.jpg", {'User-Agent' => 'ruby'})
...
file7 = URI.open("https://senmix.com/pictures/product/02/98/pochette-metis-monogram-m44875_1.jpg", {'User-Agent' => 'ruby'})
...
file8 = URI.open("https://hips.hearstapps.com/hmg-prod/images/wh-sexting-1603812586.png?crop=0.49988000959923207xw:1xh;center,top&resize=1200:*", {'User-Agent' => 'ruby'})
...
file9 = URI.open("https://images.unsplash.com/photo-1440404653325-ab127d49abc1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80", {'User-Agent' => 'ruby'})
...
file10 = URI.open("https://images.unsplash.com/photo-1517638851339-a711cfcf3279?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80", {'User-Agent' => 'ruby'})
...
file11 = URI.open("https://images.unsplash.com/photo-1602599151411-875a848f71b6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80", {'User-Agent' => 'ruby'})
...
file12 = URI.open("https://images.unsplash.com/photo-1593061231114-1798846fd643?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80", {'User-Agent' => 'ruby'})
...
file13 = URI.open("https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=327&q=80", {'User-Agent' => 'ruby'})
...
file14 = URI.open("https://images.unsplash.com/photo-1520363147109-9ab9d1c8f8a6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1256&q=80", {'User-Agent' => 'ruby'})
...
file15 = URI.open("https://images.unsplash.com/photo-1517867065801-e20f409696b0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80", {'User-Agent' => 'ruby'})
...
file16 = URI.open("https://sm.askmen.com/t/askmen_in/article/n/netflix-an/netflix-and-chill_xjgm.1200.jpg", {'User-Agent' => 'ruby'})
...
file17 = URI.open("https://d1q0twczwkl2ie.cloudfront.net/wp-content/uploads/2015/03/new.jpg", {'User-Agent' => 'ruby'})
...
file18 = URI.open("https://media.timeout.com/images/105897435/1372/1029/image.jpg", {'User-Agent' => 'ruby'})
...
file19 = URI.open("https://www.pamperedchef.ca/iceberg/com/product/100013-lg.jpg", {'User-Agent' => 'ruby'})
...
file20 = URI.open("https://www.mtl.org/sites/default/files/styles/hero/public/2022-04/44730_1.jpg?itok=qu90_lwC", {'User-Agent' => 'ruby'})
...
file21 = URI.open("https://p0.pikist.com/photos/451/474/kobo-reading-light-ebook-hammock-reading-reader-tablet-digital-holiday.jpg", {'User-Agent' => 'ruby'})
...
file22 = URI.open("https://www.comunicaffe.com/wp-content/uploads/2020/08/Dispatch_Coffee_Dispatch_Coffee_Raises__1_26M_Seed_Round_to_Fuel-scaled.jpg", {'User-Agent' => 'ruby'})
...
file23 = URI.open("https://www.headphonesty.com/wp-content/uploads/2019/10/Apple-AirPods-Pro-Featured-Image.jpg", {'User-Agent' => 'ruby'})
...
# file24 = URI.open("https://www.carsmash.nl/filt/wp-content/uploads/2020/08/Karaoke.jpg", {'User-Agent' => 'ruby'})
...
# file25 = URI.open("https://blog.goodlifefitness.com/media/1456/12008.jpg", {'User-Agent' => 'ruby'})
...
keyword_file1 = URI.open("https://images.unsplash.com/photo-1620177088260-a9150572baf4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2352&q=80", {'User-Agent' => 'ruby'})
keyword1 = Keyword.new(name: "Movies")
keyword1.photo.attach(io: keyword_file1, filename: "movies.jpg", content_type: "image/jpg")
keyword1.save!

keyword_file2 = URI.open("https://m.media-amazon.com/images/I/71xK85Lm0rL._AC_SL1500_.jpg", {'User-Agent' => 'ruby'})
keyword2 = Keyword.new(name: "Flowers")
keyword2.photo.attach(io: keyword_file2, filename: "flowers.jpg", content_type: "image/jpg")
keyword2.save!

keyword_file3 = URI.open("https://images.unsplash.com/photo-1598763773372-127da881eb84?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80", {'User-Agent' => 'ruby'})
keyword3 = Keyword.new(name: "Food")
keyword3.photo.attach(io: keyword_file3, filename: "tacos.jpg", content_type: "image/jpg")
keyword3.save!

keyword_file4 = URI.open("https://images.unsplash.com/photo-1551632811-561732d1e306?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80", {'User-Agent' => 'ruby'})
keyword4 = Keyword.new(name: "Hiking")
keyword4.photo.attach(io: keyword_file4, filename: "hiking.jpg", content_type: "image/jpg")
keyword4.save!

keyword_file5 = URI.open("https://images.unsplash.com/photo-1561461056-77634126673a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80", {'User-Agent' => 'ruby'})
keyword5 = Keyword.new(name: "Wine")
keyword5.photo.attach(io: keyword_file5, filename: "wine.jpg", content_type: "image/jpg")
keyword5.save!

keyword_file6 = URI.open("https://images.unsplash.com/photo-1545989253-02cc26577f88?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80", {'User-Agent' => 'ruby'})
keyword6 = Keyword.new(name: "Art")
keyword6.photo.attach(io: keyword_file6, filename: "art.jpg", content_type: "image/jpg")
keyword6.save!

keyword_file7 = URI.open("https://images.unsplash.com/photo-1535905557558-afc4877a26fc?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80", {'User-Agent' => 'ruby'})
keyword7 = Keyword.new(name: "Books")
keyword7.photo.attach(io: keyword_file7, filename: "books.jpg", content_type: "image/jpg")
keyword7.save!

keyword_file8 = URI.open("https://images.unsplash.com/photo-1561715276-a2d087060f1d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80", {'User-Agent' => 'ruby'})
keyword8 = Keyword.new(name: "Shopping")
keyword8.photo.attach(io: keyword_file8, filename: "shopping.jpg", content_type: "image/jpg")
keyword8.save!

keyword_file9 = URI.open("https://images.unsplash.com/photo-1596018589855-e9a2a91f687f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1925&q=80", {'User-Agent' => 'ruby'})
keyword9 = Keyword.new(name: "Coffee")
keyword9.photo.attach(io: keyword_file9, filename: "coffee.jpg", content_type: "image/jpg")
keyword9.save!

keyword_file10 = URI.open("https://images.unsplash.com/photo-1507838153414-b4b713384a76?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80", {'User-Agent' => 'ruby'})
keyword10 = Keyword.new(name: "Music")
keyword10.photo.attach(io: keyword_file10, filename: "music.jpg", content_type: "image/jpg")
keyword10.save!

keyword_file11 = URI.open("https://images.unsplash.com/photo-1572252821143-035a024857ac?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=986&q=80", {'User-Agent' => 'ruby'})
keyword11 = Keyword.new(name: "Cats")
keyword11.photo.attach(io: keyword_file11, filename: "cats.jpg", content_type: "image/jpg")
keyword11.save!

keyword_file12 = URI.open("https://images.unsplash.com/photo-1506126613408-eca07ce68773?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1399&q=80", {'User-Agent' => 'ruby'})
