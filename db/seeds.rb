...
user1.photo.attach(io: File.open(user_file_a), filename: "user1.jpg", content_type: "image/jpg")
user1.save!
user_file_a.rewind
...
user3.photo.attach(io: File.open(user_file_b), filename: "user3.jpg", content_type: "image/jpg")
user3.save!
user_file_b.rewind
...
partner1.photo.attach(io: File.open(partner_file_a), filename: "partner1.jpg", content_type: "image/jpg")
partner1.user = user1
partner1.save!
partner_file_a.rewind
...
inspo1.photo.attach(io: File.open(file_a), filename: "inspo1.jpg", content_type: "image/jpg")
inspo1.save!
file_a.rewind
...
inspo2.photo.attach(io: File.open(file_b), filename: "inspo7.jpg", content_type: "image/jpg")
inspo2.save!
file_b.rewind
...
inspo3.photo.attach(io: File.open(file_c), filename: "inspo3.jpg", content_type: "image/jpg")
inspo3.save!
file_c.rewind
...
inspo4.photo.attach(io: File.open(file_d), filename: "inspo4.jpg", content_type: "image/jpg")
inspo4.save!
file_d.rewind
...
inspo5.photo.attach(io: File.open(file_e), filename: "inspo5.jpg", content_type: "image/jpg")
inspo5.save!
file_e.rewind
...
inspo6.photo.attach(io: File.open(file_f), filename: "inspo6.jpg", content_type: "image/jpg")
inspo6.save!
file_f.rewind
...
inspo7.photo.attach(io: File.open(file_g), filename: "inspo2.jpg", content_type: "image/jpg")
inspo7.save!
file_g.rewind
...
inspo8.photo.attach(io: File.open(file_h), filename: "inspo8.png", content_type: "image/png")
inspo8.save!
file_h.rewind
...
inspo9.photo.attach(io: File.open(file_i), filename: "inspo9.jpg", content_type: "image/jpg")
inspo9.save!
file_i.rewind
...
inspo10.photo.attach(io: File.open(file_j), filename: "inspo10.jpg", content_type: "image/jpg")
inspo10.save!
file_j.rewind
...
inspo11.photo.attach(io: File.open(file_k), filename: "inspo11.jpg", content_type: "image/jpg")
inspo11.save!
file_k.rewind
...
inspo12.photo.attach(io: File.open(file_l), filename: "inspo12.jpg", content_type: "image/jpg")
inspo12.save!
file_l.rewind
...
inspo13.photo.attach(io: File.open(file_m), filename: "inspo13.jpg", content_type: "image/jpg")
inspo13.save!
file_m.rewind
...
inspo14.photo.attach(io: File.open(file_n), filename: "inspo14.jpg", content_type: "image/jpg")
inspo14.save!
file_n.rewind
...
inspo15.photo.attach(io: File.open(file_o), filename: "inspo15.jpg", content_type: "image/jpg")
inspo15.save!
file_o.rewind
...
inspo16.photo.attach(io: File.open(file_p), filename: "inspo16.jpg", content_type: "image/jpg")
inspo16.save!
file_p.rewind
...
inspo17.photo.attach(io: File.open(file_q), filename: "inspo17.jpg", content_type: "image/jpg")
inspo17.save!
file_q.rewind
...
inspo18.photo.attach(io: File.open(file_r), filename: "inspo18.jpg", content_type: "image/jpg")
inspo18.save!
file_r.rewind
...
inspo19.photo.attach(io: File.open(file_s), filename: "inspo19.jpg", content_type: "image/jpg")
inspo19.save!
file_s.rewind
...
inspo20.photo.attach(io: File.open(file_t), filename: "inspo20.jpg", content_type: "image/jpg")
inspo20.save!
file_t.rewind
...
inspo21.photo.attach(io: File.open(file_u), filename: "inspo21.jpg", content_type: "image/jpg")
inspo21.save!
file_u.rewind
...
inspo22.photo.attach(io: File.open(file_v), filename: "inspo22.jpg", content_type: "image/jpg")
inspo22.save!
file_v.rewind
...
inspo23.photo.attach(io: File.open(file_w), filename: "inspo23.jpg", content_type: "image/jpg")
inspo23.save!
file_w.rewind
...
# inspo24.photo.attach(io: File.open(file_x), filename: "inspo24.jpg", content_type: "image/jpg")
# inspo24.save!
# file_x.rewind
...
# inspo25.photo.attach(io: File.open(file_y), filename: "inspo25.jpg", content_type: "image/jpg")
# inspo25.save!
# file_y.rewind
...
keyword1.photo.attach(io: File.open(keyword_file_a), filename: "movies.jpg", content_type: "image/jpg")
keyword1.save!
keyword_file_a.rewind
...
keyword2.photo.attach(io: File.open(keyword_file_b), filename: "flowers.jpg", content_type: "image/jpg")
keyword2.save!
keyword_file_b.rewind
...
keyword3.photo.attach(io: File.open(keyword_file_c), filename: "tacos.jpg", content_type: "image/jpg")
keyword3.save!
keyword_file_c.rewind
...
keyword4.photo.attach(io: File.open(keyword_file_d), filename: "hiking.jpg", content_type: "image/jpg")
keyword4.save!
keyword_file_d.rewind
...
keyword5.photo.attach(io: File.open(keyword_file_e), filename: "wine.jpg", content_type: "image/jpg")
keyword5.save!
keyword_file_e.rewind
...
keyword6.photo.attach(io: File.open(keyword_file_f), filename: "art.jpg", content_type: "image/jpg")
keyword6.save!
keyword_file_f.rewind
...
keyword7.photo.attach(io: File.open(keyword_file_g), filename: "books.jpg", content_type: "image/jpg")
keyword7.save!
keyword_file_g.rewind
...
keyword8.photo.attach(io: File.open(keyword_file_h), filename: "shopping.jpg", content_type: "image/jpg")
keyword8.save!
keyword_file_h.rewind
...
keyword9.photo.attach(io: File.open(keyword_file_i), filename: "coffee.jpg", content_type: "image/jpg")
keyword9.save!
keyword_file_i.rewind
...
keyword10.photo.attach(io: File.open(keyword_file_j), filename: "music.jpg", content_type: "image/jpg")
keyword10.save!
keyword_file_j.rewind
...
keyword11.photo.attach(io: File.open(keyword_file_k), filename: "cats.jpg", content_type: "image/jpg")
keyword11.save!
keyword_file_k.rewind
...
keyword12.photo.attach(io: File.open(keyword_file_l), filename: "meditation.jpg", content_type: "image/jpg")
keyword12.save!
keyword_file_l.rewind
